...
`,k=()=>(0,n.jsx)(R.Global,{styles:C}),P=({scope:e=""})=>(0,n.jsx)(R.Global,{styles:T`
      html {
        line-height: 1.5;
...
`});var U=e.i(358280);let Y=({children:e})=>(0,n.jsxs)(U.I18nProvider,{i18n:r.i18n,children:[e," "]});var Q=e.i(418755),G=e.i(613616),H=e.i(887527),V=b,K=e.i(428683),X=e.i(676828),Z=e.i(382167),J=e.i(918228),ee=e.i(649543),et=e.i(969641),er=e.i(344233),eo=e.i(775493),en=e.i(704077),ei=e.i(112010),ea=e.i(588183),el=e.i(575329),es=e.i(751827),eu=e.i(406112),ed=e.i(524473),ec=e.i(541075),eh=e.i(849187),eb=e.i(542862),ef=e.i(203828),ep=e.i(175440),em=e.i(877147);let e_=({onLocaleSelect:e,selectedLocale:t,renderAsLinks:r=!1,locales:o})=>{let i=(()=>{let{asPath:e}=(0,ef.useRouter)();return(0,b.useCallback)(t=>{let r=e.split("?")[0],o=r.split("/").filter(Boolean),n=o[0],i=ep.SUPPORTED_LOCALE_KEYS.includes(n)&&"en"!==n?1===o.length?"/":"/"+o.slice(1).join("/"):r,a=e.split("?")[1],l=r;return em.LOCALIZED_MARKETING_SITE_PATHS.includes(i)?(ep.SUPPORTED_LOCALE_KEYS.includes(t)&&(l="en"===t?""===i?"/":i:`/${t}${"/"===i?"":i}`),`${l}${a?`?${a}`:""}`):null},[e])})();return(0,n.jsx)(eb.LocalePickerList,{locales:o,onLocaleSelect:e,selectedLocale:t,renderAsLinks:r,getLocalizedUrlFn:i})};var eg=e.i(200456),ey=e.i(45652),ev=e.i(661619),ew=e.i(405054);let eS=({onLocaleSelect:e,selectedLocaleKey:t,buttonProps:o,showLabelOnMobile:i=!1,activatorDataId:a,renderAsLinks:l=!1,iconOnly:s=!1})=>{let{isOpen:u,onOpen:d,onClose:c}=(0,eu.useDisclosure)(),h=(0,eh.useFeatureFlag)("i18nEnabled"),b=(0,ev.getSupportedLocaleOptionsSorted)().filter(e=>h||"private_beta"!==ep.LOCALE_ROLLOUT_MAP[e.key]),f=(0,ey.useSSRMounted)(),p=eg.SUPPORTED_LOCALE_OPTIONS[t];return(0,n.jsxs)(n.Fragment,{children:[s?(0,n.jsx)(er.IconButton,{onClick:d,"aria-label":r.i18n._({id:"-DEogc",message:"Change language"}),icon:(0,n.jsx)(ec.FontAwesomeIcon,{icon:ed.faGlobe}),variant:"ghost",alignContent:"center",size:"md",fontWeight:500,...o}):(0,n.jsxs)(n.Fragment,{children:[f&&p&&(0,n.jsx)(et.Button,{w:"fit-content",onClick:d,display:{base:i?"block":"none",md:"block"},leftIcon:(0,n.jsx)(K.Box,{display:"inline-block",children:(0,n.jsx)(ec.FontAwesomeIcon,{icon:ed.faGlobe})}),textDecoration:"none !important",alignContent:"center",size:"sm",variant:"ghost",...o,...a&&{"data-id":a},children:p.displayName}),(0,n.jsx)(er.IconButton,{onClick:d,display:{base:i?"none":"block",md:"none"},"aria-label":r.i18n._({id:"-DEogc",message:"Change language"}),icon:(0,n.jsx)(ec.FontAwesomeIcon,{icon:ed.faGlobe}),variant:"ghost",alignContent:"center",size:"md",fontWeight:500,...o})]}),u&&(0,n.jsxs)(eo.Modal,{isOpen:u,onClose:c,size:"6xl",isCentered:!1,preserveScrollBarGap:!0,blockScrollOnMount:!0,scrollBehavior:"outside",children:[(0,n.jsx)(es.ModalOverlay,{zIndex:{base:"tooltip",md:void 0}}),(0,n.jsxs)(ea.ModalContent,{m:{base:4,md:20},containerProps:{zIndex:{base:"tooltip",md:void 0}},children:[(0,n.jsx)(el.ModalHeader,{textAlign:"center",fontSize:{base:"xl",md:"3xl"},children:(0,n.jsx)(U.Trans,{id:"EghcSN",message:"Choose language"})}),(0,n.jsx)(ei.ModalCloseButton,{}),(0,n.jsx)(en.ModalBody,{children:(0,n.jsx)(e_,{selectedLocale:eg.SUPPORTED_LOCALE_OPTIONS[t],onLocaleSelect:t=>{(0,ew.isLanguageSupported)(t)?(e?.(t),c()):console.error(`Invalid locale key: ${t}`)},renderAsLinks:l,locales:b})})]})]})]})};var eR=e.i(816350),eT=e.i(130833),eC=e.i(616358);let ek=({buttonProps:e,showLabelOnMobile:t=!1,iconOnly:r=!1})=>{let o=(0,eR.useLinguiLocale)(),i=(0,b.useMemo)(()=>o,[]),[a,l]=(0,b.useState)(i);(0,eT.useLocalePreview)(a);let s=(0,b.useCallback)(e=>{l(e),(0,eC.setGammaLocaleCookie)(e)},[]);return(0,n.jsx)(eS,{selectedLocaleKey:o,onLocaleSelect:s,buttonProps:e,showLabelOnMobile:t,iconOnly:r})};e.i(962364).default,e.i(528446).default;var eP=e.i(132421);let eE=()=>{let e=(0,eR.useLinguiLocale)();return(0,n.jsxs)(J.Stack,{direction:"row",justify:"space-between",alignItems:"center",children:[(0,n.jsx)(Z.Link,{href:("en"===e||!e||!ep.SUPPORTED_LOCALE_KEYS.includes(e)?{home:"/",pricing:"/pricing"}:{home:`/${e}`,pricing:`/${e}/pricing`}).home,isExternal:!0,children:(0,n.jsx)(ee.GammaLogo,{w:"100px"})}),(0,n.jsx)(ek,{buttonProps:{variant:"ghost"}})]})},ex=({lede:e,title:t,children:r,stackProps:o,showFooter:i=!1})=>(0,n.jsxs)(J.Stack,{bg:"white",padding:{base:6,md:8},zIndex:"2",borderRadius:{base:"none",md:"xl"},shadow:{base:"none",md:"lg"},maxW:"100%",w:{base:"100%",md:"500px"},spacing:8,m:{base:0,md:8},minH:{base:"100%",md:"auto"},...o,children:[(0,n.jsx)(eE,{}),e&&("string"==typeof e?(0,n.jsx)(H.Text,{fontSize:"sm",color:"gray.500",children:e}):e),t&&(0,n.jsx)(X.Heading,{size:"lg",children:t}),(0,n.jsx)(K.Box,{flex:1,children:r}),i&&(0,n.jsx)(ej,{})]}),ej=()=>(0,n.jsx)(J.Stack,{mt:12,align:"center",children:(0,n.jsxs)(H.Text,{color:"gray.300",fontSize:"xs",sx:{a:{color:"gray.400",_hover:{textDecoration:"underline"}}},children:[(0,n.jsx)(Z.Link,{href:eP.TERMS_OF_SERVICE_URL,children:"Terms of Service"})," •"," ",(0,n.jsx)(Z.Link,{href:eP.PRIVACY_POLICY_URL,children:"Privacy Policy"})]})});class eq extends V.Component{constructor(e){super(e),this.state={hasError:!1,errMessage:"",shouldMountChildren:!0}}static getDerivedStateFromError(e){return{hasError:!0,errMessage:e.message,shouldMountChildren:!1}}render(){return(0,n.jsxs)(n.Fragment,{children:[this.state.hasError&&(0,n.jsx)(eO,{errMessage:""===this.state.errMessage?void 0:this.state.errMessage}),this.state.shouldMountChildren&&this.props.children]})}}let eO=({errMessage:e,...t})=>(0,n.jsx)(G.Flex,{"data-error-component":!0,w:"100vw",h:"100vh",overflow:"hidden",bg:"gray.50",zIndex:99999,...t,children:(0,n.jsx)(G.Flex,{justifyContent:"center",alignItems:"center",flex:1,p:[4,16],left:"50%",top:"50%",children:(0,n.jsx)(ex,{lede:"",title:"Uh oh.",stackProps:{shadow:"lg-dark",position:"relative"},children:(0,n.jsx)(H.Text,{children:e||"An unexpected error occurred."})})})});var ez=e.i(763896),eA=e.i(982725),eL=e.i(304521),eW=e.i(833200),e$=e.i(25747);let eI=({children:e})=>{let[t]=(0,b.useState)(()=>{let e,t=eA.default.get("gamma_visitor_id")||"unknown";return{anonymousUser:{id:t,displayName:t?(0,eW.generateName)(t):""},isUserLoading:!1,userStatus:"loggedOut",isGammaAdminUser:!1,isGammaOrgUser:!1,color:{value:e=t?(0,eW.generateColor)(t):"#cccccc",isDark:(0,eL.default)(e).isDark()},setCurrentWorkspaceId:()=>{}}});return(0,n.jsx)(e$.UserContext.Provider,{value:t,children:e})},eB=(0,Q.getStore)(),eM=(0,A.extendTheme)(L.themeWithRebrand,{styles:{global:{".ProseMirror":{outline:"0 none"}}}}),eF=({children:e})=>{console.log("🚀 GammaSite sites wrapper rendered"),(0,ey.useSSRInitialize)();let t=(0,b.useMemo)(()=>new I.ApolloClient({cache:new B.InMemoryCache,devtools:{enabled:!1},link:D,ssrMode:!0}),[]),r=(0,ez.useCreateTooltipPortal)();return(0,n.jsx)($.Provider,{store:eB,children:(0,n.jsx)(Y,{children:(0,n.jsxs)(z,{theme:eM,resetCSS:!1,children:[(0,n.jsx)(N,{}),(0,n.jsx)(eq,{children:(0,n.jsx)(u,{client:t,children:(0,n.jsx)(eI,{children:(0,n.jsx)(ez.TooltipPortalRefProvider,{value:r,children:e})})})})]})})})};e.s(["GammaSiteProviders",0,({children:e})=>(0,n.jsxs)(eF,{children:[(0,n.jsxs)(W.default,{children:[(0,n.jsx)("meta",{content:"Gamma",property:"og:title"},"og:title"),(0,n.jsx)("link",{href:"https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900",rel:"stylesheet"})]}),e]})],584770)}]);

//# sourceMappingURL=11_hj2dm5.iqs.js.map